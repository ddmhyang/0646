...
?>
<div class="container_gallery_Charcter_edit">
<div class="form-wrap">
  <h2>Charcter — 수정</h2>
  <form id="form_edit">
    ...
    <div class="form-actions">
      ...
      <a href="#/gallery_Charcter/detail/<?= $post['id'] ?>" class="btn btn-secondary">취소</a>
    </div>
  </form>
</div>
<script>
...
$('#form_edit').on('submit', function(e) {
  ...
  function doSave(thumbUrl) {
    ...
    $.post('ajax_save_gallery_Charcter.php', data)
     .done(function(d) { if(d.success) location.hash='#/gallery_Charcter/detail/'+d.id; else alert(d.message); });
  }
