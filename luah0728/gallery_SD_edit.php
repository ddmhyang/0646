...
?>
<div class="container_gallery_SD_edit">
<div class="form-wrap">
  <h2>SD — 수정</h2>
  <form id="form_edit">
    ...
    <div class="form-actions">
      ...
      <a href="#/gallery_SD/detail/<?= $post['id'] ?>" class="btn btn-secondary">취소</a>
    </div>
  </form>
</div>
<script>
...
$('#form_edit').on('submit', function(e) {
  ...
  function doSave(thumbUrl) {
    ...
    $.post('ajax_save_gallery_SD.php', data)
     .done(function(d) { if(d.success) location.hash='#/gallery_SD/detail/'+d.id; else alert(d.message); });
  }
